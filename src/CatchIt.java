...
public class CatchIt extends JFrame implements KeyListener,Runnable,MouseMotionListener 
{
	...
	Thread th,th1;
	int move=300;
	static int score=0,seconds=0,hrs=0,min=0;
	static int value=0,x1,index;
	char ch3='p',ch4='r';
	  char c3='a' , c4='d';
	CatchIt() throws Exception
	{
		setLayout(null);
	...
	//	fruit[1].setBounds(60, 20, 100, 50);
		...
		getContentPane().add(scorel=new JLabel("<html><font color='red' size='+2'> SCORE : </html>"));
		scorel.setBounds(1100, 20, 100, 50);
